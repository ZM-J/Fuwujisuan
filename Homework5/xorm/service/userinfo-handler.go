...
import (
	...
	"github.com/ZM-J/Fuwujisuan/Homework5/xorm/entities"
...
func postUserInfoHandler(formatter *render.Render) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, req *http.Request) {
		req.ParseForm()
		if len(req.Form["username"]) == 0 || len(req.Form["departname"]) == 0 || len(req.Form["username"][0]) == 0{
...
func getUserCountHandler(formatter *render.Render) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, req *http.Request) {
		c := entities.UserInfoService.CountNum()
